...
Property( "BGQ-core", "app.transferSizeX", lambda gid, cid, cids, index: 16000 )
Property( "BGQ-core", "app.transferSizeY", lambda gid, cid, cids, index: 16000 )
Property( "BGQ-core", "app.transferSizeZ", lambda gid, cid, cids, index: 16000 )
