...
Property( "BGQ-core", "app.elementSize", lambda gid, cid, cids, index: 6 )
Property( "BGQ-core", "app.elementsPerProcess", lambda gid, cid, cids, index: 64 )
Property( "BGQ-core", "app.transferSizeX", lambda gid, cid, cids, index: 23040 )
Property( "BGQ-core", "app.transferSizeY", lambda gid, cid, cids, index: 23040 )
Property( "BGQ-core", "app.transferSizeZ", lambda gid, cid, cids, index: 23040 )
...
Operation( "BGQ-core", "unwait", NoLookup, None,
           Recv(True))
Operation( "BGQ-core", "computeConv", "vulcan-compute-conv.csv", "linear",
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )
Operation( "BGQ-core", "computedr", "vulcan-compute-dr.csv", "linear",
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )
Operation( "BGQ-core", "computeds", "vulcan-compute-ds.csv", "linear",
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )
Operation( "BGQ-core", "computedt", "vulcan-compute-dt.csv", "linear",
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )
Operation( "BGQ-core", "computeSum", "vulcan-compute-sum.csv", "linear",
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )
Operation( "BGQ-core", "computerk", "vulcan-compute-rk.csv", "linear",
           Loiter( "usage", "==", 0.0),
           Modify( "usage", 1.0 ),
           Dawdle( AnyOutput() ),
           Modify( "usage", 0.0 ) )
...
Component( "system" )
Offspring( "system", Torus( "BGQ-core", "BGQ-network", [ 4, 4, 4, 2, 2 ] ) )
Root("system")
