...
Program( "xeon-e5-core", "toddler.smc" )
...
Operation( "occ", "transfer", "transfer-dummy-A.csv",
           Loiter( "usage", "==", 0.0 ),
           Modify( "usage", 1.0 ),
           Dawdle( 0.003 ),
           Modify( "usage", 0.0 ) )
...
# Four cores per CPU.
Offspring( "xeon-e5", Mesh("xeon-e5-core", "occ", [8, 8] ) )
...
Operation( "eth", "transfer", "transfer-dummy-B.csv",
           Loiter( "usage", "==", 0.0 ),
           Modify( "usage", 1.0 ),
           Dawdle( 0.003 ),
           Modify( "usage", 0.0 ) )
...
Component( "system" )
Offspring( "system", Torus("node", "eth", [10, 10]) ) # 3D-Torus.
